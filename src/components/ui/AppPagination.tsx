...
export const AppPagination: React.FC<Props> = ({ current, total, onChange, maxVisible = 5 }) => {
  ...
  const btnActive = "bg-primary border-primary text-white shadow-md shadow-primary/20";
  const btnInactive = "bg-card border-border text-secondary-foreground hover:border-primary hover:text-primary hover:bg-primary-light-bg/30";
  const btnDisabled = "bg-accent/50 border-border text-muted-foreground opacity-40 cursor-not-allowed";
