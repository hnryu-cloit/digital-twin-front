...
export const SettingsPage: React.FC = () => {
 ...
 <div className="flex h-full w-full max-w-6xl overflow-hidden rounded-[32px] border border-[var(--border)] bg-card shadow-[var(--shadow-lg)] animate-in fade-in zoom-in duration-500">
 {/* Sidebar Nav */}
 <nav className="hide-scrollbar w-64 shrink-0 overflow-y-auto border-r border-[var(--border)] bg-card px-4 py-8">
 {NAV.map((section) => (
