...
const TYPE_COLORS: Record<QuestionType, { bg: string; text: string; border: string }> = {
  ...
  복수선택: { bg: "#E0E7FF", text: "#4338CA", border: "#C7D2FE" },
  리커트척도: { bg: "#F0F9FF", text: "#0369A1", border: "#B9E6FE" },
  주관식: { bg: "#F1F5F9", text: "#475569", border: "#E2E8F0" },
};
...
function TooltipMenu({ onClose }: TooltipMenuProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 top-8 z-20 bg-card border border-[var(--border)] rounded-xl shadow-[var(--shadow-lg)] py-1.5 w-48 animate-in fade-in slide-in-from-top-2 duration-200"
    >
      {[
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-[420px] shrink-0 flex flex-col bg-card border-r border-[var(--border)] overflow-hidden">
          ...
          <div className="px-6 py-5 border-b border-[var(--border)] bg-[var(--panel-soft)]">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-9 h-9 rounded-xl bg-primary flex items-center justify-center shadow-[var(--shadow-sm)]">
        ...
        <div className="flex-1 flex flex-col bg-background overflow-hidden">
          ...
          <div className="h-16 shrink-0 flex items-center justify-between px-8 bg-card border-b border-[var(--border)]">
            ...
            <button
              onClick={addQuestion}
              className="flex items-center gap-2 bg-primary text-white px-5 py-2 rounded-xl font-semibold hover:bg-primary-hover transition-colors shadow-[var(--shadow-sm)] active:scale-95 text-[13px]"
            >
                    ...
                    <div className="flex items-center gap-2.5 shrink-0 pt-0.5">
                      ...
                      <span
                        className={cn(
                          ...
                          "h-9 min-w-11 rounded-lg px-3 text-[12px] font-bold shadow-[var(--shadow-sm)] pointer-events-none select-none",
                        )}
                      >
                        Q{globalIdx + 1}
                      </span>
                    ...
                    {editingId !== q.id && (
                      <div className="flex items-center gap-1.5 shrink-0 opacity-0 group-hover:opacity-100 transition-all translate-x-1 group-hover:translate-x-0 pt-0.5">
                        ...
                        <button
                          ...
                          className="w-8 h-8 rounded-lg flex items-center justify-center bg-[var(--panel-soft)] hover:bg-red-50 text-[var(--subtle-foreground)] hover:text-destructive transition-colors border border-[var(--border)] hover:border-red-200"
                          title="삭제"
                        >
                          <Trash2 size={14} />
                        </button>
          ...
          <div className="shrink-0 bg-card border-t border-[var(--border)] px-8 py-4 flex items-center justify-between shadow-[0_-4px_14px_rgba(0,0,0,0.04)]">
            ...
            <div className="flex gap-2.5">
              ...
              <button className="px-8 py-2.5 rounded-xl bg-primary text-white font-semibold hover:bg-primary-hover transition-colors shadow-[var(--shadow-sm)] active:scale-95 text-[13px]">
                설문 저장 및 확정
              </button>
            </div>
          </div>
